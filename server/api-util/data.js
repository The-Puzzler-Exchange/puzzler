/**
 * Helpers for denormalising Marketplace/Integration API responses on the server.
 * These are the server-side counterparts of the functions in src/util/data.js
 */
